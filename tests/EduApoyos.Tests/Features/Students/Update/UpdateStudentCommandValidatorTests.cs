...
public sealed class UpdateStudentCommandValidatorTests
{
    ...
    private static UpdateStudentCommand ValidCommand(
        Action<UpdateStudentCommandBuilder>? mutate = null)
    {
        var builder = new UpdateStudentCommandBuilder();
    ...
    {
        var command = ValidCommand(b => b.Id = Guid.Empty);
    ...
    private sealed class UpdateStudentCommandBuilder
    {
        ...
        public UpdateStudentCommand Build() =>
